...
<template>
  <div id="goods">
    <div v-cloak>
      <div v-if="details">
            ...
            <div class="content-body">
              ...
              <div class="goods-header">
                ...
                <div class="goods-price">
                  <div class="current-price">
                    <span>¥</span>
                    <i class="js-goods-price price">{{details.price | currency}}</i>
                  </div>
                  <span class="btn btn-blue btn-retail hide js-retail-btn">门店有售</span>
                  <div class="original-price">{{details.originalPrice | currency}}</div>
                </div>
                <hr class="with-margin-l">
                <div class="stock-detail">
                  <dl>
                    <dt>运费:</dt>
                    <dd class="js-postage-desc" data-postage="免运费">{{details.postage}}</dd>
                  </dl>
                  <dl>
                    <dt>剩余:</dt>
                ...
                <div class="block block-list goods-store">
                  <div class="custom-store block-item">
                    <!-- <a class="custom-store-link clearfix" href="https://h5.youzan.com/v2/home/cz0mk59k"> -->
                      ...
                      <div class="custom-store-name">{{details.storeName}}</div>
                  ...
                  <div class="renzheng block-item">
                    ...
                    v-for="identification in details.identification" :key="identification.id">
                      <span class="rz-name font-size-12 c-gray-darker">{{identification}}</span>
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div class="js-detail-container" style="margin-top: 10px;">
                <div class="js-tabber-container goods-detail">
                  ...
                  <div class="js-tabber-content">
                    <!-- 本店成交 -->
                    <div class="js-part" data-type="sales" v-show="curIndex === 1">
                      <div class="js-traderecord-list block-list-traderecord">
                        ...
                        <div class="js-list b-list block block-list">
                          <li class="block-item" v-for="item in dealList" :key="item.id">
              ...
              <div class="js-bottom-opts js-footer-auto-ele stick-bottom">
                ...
                <div class="stick-bottom-btns">
                  ...
                  <div class="btn-buy">
                    <a href="javascript:;" class="js-buy-it" @click="chooseSku(3)">立即购买</a>
                  </div>
                </div>
              </div>
        ...
        <transition name="popout">
          <div
            ...
            style="overflow: hidden; position: fixed; z-index: 1000; background: white; bottom: 0px; left: 0px; right: 0px; "
            v-show="showSku"
          >
              ...
              <div class="detail goods-base-info clearfix">
                ...
                <div class="goods-price clearfix">
                  <div class="current-price pull-left c-black">
                    ...
                    <i class="js-goods-price price font-size-16 vertical-middle c-orange">{{details.price | currency}}</i>
                  </div>
                  <div class="original-price vertical-middle font-size-14 line-through">{{details.originalPrice | currency}}</div>
                </div>
              </div>
              <div class="js-cancel sku-cancel">
                <div class="cancel-img" @click="showSku = false"></div>
              </div>
            </div>
      ...
      <!-- 未获取到数据前的loading状态 -->
      <div class="loading-more" v-if="!details"><span></span></div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    getDetails(){
      this.axios.get(this.url.details,{id})
        .then(res => {
          this.details = res.data.data

          this.SwipeList = []
          this.details.imgs.forEach(ele => {
            this.SwipeList.push({
              "clickUrl": '',
              "img": ele
            })
...
<style scoped>
@import url("./assets/goods_common.css");
@import url("./assets/goods_custom.css");
@import url("./assets/goods_mars.css");
@import url("./assets/goods_sku.css");
@import url("./assets/goods_theme.css");
...
.popout-enter, .popout-leave-to {
  transform: translateY(100%);
}

.mask-enter-active, .mask-leave-avtive {
...
.add-cart-enter, .add-cart-leave-to {
  opacity: 0;
}
</style>